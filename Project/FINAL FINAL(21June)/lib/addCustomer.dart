  ...
  return Container(
    ...
    child:RaisedButton(
      ...
      onPressed: () async {
        ...
        var xyz=await c.checkValidity(password.text, email.text, contact_num.text, fname.text, lname.text);
        if (passValid==false) {
...
class addCustomer extends StatelessWidget{
  void checkValidity(String password, String email,String contact_num, String fname, String lname) async {
    int issues=0;
    // setState((){
    message="";
    ...
    //check name for presence of digits
    int nameIntegers = 0;
