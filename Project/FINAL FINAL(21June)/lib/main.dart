...
class LoginPageState extends State<LoginPage>
    ...
    return Column(
      ...
      children: <Widget>[
        Text(
          'Email',
          style: TextStyle(
              color: Color(0xff8c4b83), fontSize: 16, fontWeight: FontWeight.bold),
        ),
        SizedBox(height: 2),
        Container(
          ...
          child: TextField(
            ...
            decoration: InputDecoration(
                ...
                prefixIcon: Icon(Icons.email, color: Color(0xff8c4b83)),
                hintText: 'Email',
        ...
        Container(
          ...
          child: TextField(
            ...
            decoration: InputDecoration(
                border: InputBorder.none,
                contentPadding: EdgeInsets.only(top: 14),
                prefixIcon: Icon(Icons.lock, color: Color(0xff8c4b83)),
                hintText: 'Password',
                hintStyle: TextStyle(color: Colors.black38)),
          ),
        ),
  ...
  Widget build(BuildContext context) {
    return MaterialApp(
    home: Container( decoration: BoxDecoration(image:DecorationImage(image: new AssetImage("assets/images/login-100.jpg"), fit: BoxFit.fill)),

        child:Stack(
      children: <Widget>[
    Image.asset(
    "assets/images/loading-100.jpg",
    ...
    Scaffold(
      ...
      body: new Stack(fit: StackFit.expand, children: <Widget>[
        new Container(
      decoration: new BoxDecoration(image: new DecorationImage(image: new AssetImage("assets/images/login-100.jpg"), fit: BoxFit.fill)),
