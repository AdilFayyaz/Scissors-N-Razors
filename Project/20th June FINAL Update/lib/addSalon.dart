      ...
      SingleChildScrollView(
        ...
        children: [
          ...
          Container(
            ...
            child: TextField(
                controller: address,
                decoration: InputDecoration(hintText: 'Address',border: new OutlineInputBorder(
                  borderRadius: const BorderRadius.all(
                    const Radius.circular(20.0),
                  ),
                ),contentPadding:EdgeInsets.symmetric(vertical: 20, horizontal: 15),)
          ...
          Container(
            ...
            child: TextField(
              ...
              decoration: InputDecoration(hintText: 'Longitude', border: new OutlineInputBorder(
                borderRadius: const BorderRadius.all(
                  const Radius.circular(20.0),
                ),
              ),contentPadding:EdgeInsets.symmetric(vertical: 20, horizontal: 15),),
          ...
          Container(
            ...
            child: TextField(
              controller: latitude,
              decoration: InputDecoration(hintText:'Latitude', border: new OutlineInputBorder(
                borderRadius: const BorderRadius.all(
                  const Radius.circular(20.0),
                ),
              ),contentPadding:EdgeInsets.symmetric(vertical: 20, horizontal: 15),),
          ...
          Container(
            ...
            child: FlatButton(
              child: Text('Use My Current Location', style: TextStyle(fontSize: 20.0),),
                  ...
                  children: <Widget>[
                    ...
                    InkWell(
                      ...
                      child: Container(
                        ...
                        decoration: BoxDecoration(color: Color(0xff288491),borderRadius: BorderRadius.all(Radius.circular(20))),
                        child: TextFormField(
