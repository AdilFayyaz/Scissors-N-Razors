    ...
    return Scaffold(
      ...
      SearchAppBar(
        ...
        body:Stack(
            children: <Widget>[
        new Container(
        decoration: new BoxDecoration(image: new DecorationImage(image: new AssetImage("assets/images/3-100.jpg"), fit: BoxFit.fill)),
      )
      , Column(

          mainAxisSize: MainAxisSize.min,
          children: <Widget>[
            SizedBox(width: 400, height: 120,),
            Container(
          ...
          Container(
            padding: const EdgeInsets.symmetric(vertical:40),//80
            child: Text(
              'Top Trending',
          ...
          Expanded(
            child: Container(
              ...
              child: ListView.builder(
                ...
                itemCount: SalonNames.length, //show top 6 salons
                          ...
                          Container(
                            decoration: BoxDecoration(
                              image: DecorationImage(
                                image: AssetImage("assets/images/menuNavBar3.jpg"),
                                fit: BoxFit.fill,
