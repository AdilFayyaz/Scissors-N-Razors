      ...
      child: ListView(
        ...
        children: <Widget>[
          ...
          ListTile(
            ...
            onTap: () => {Navigator.push(context,MaterialPageRoute(builder: (_)=>viewCustomerAppointments(email))),},
          ),
          ListTile(
          ...
          ListTile(
            ...
            onTap: () => {
              Navigator.push(context,MaterialPageRoute(builder: (_)=>viewCustomerAppointments(email))),
            },
          ),
          ListTile(
