...
class viewSalon extends StatefulWidget{
  ...
  viewSalon(this.salonname);
  @override
  viewSalonList createState() => viewSalonList(this.salonname);
}
        ...
        child: StreamBuilder<QuerySnapshot>(
            ...
            Container(
              ...
              child: FlatButton(
                ...
                onPressed: () {
                  Navigator.push(context,MaterialPageRoute(builder: (_)=>bookAppointment(cart,salonname)));
                },
              ),
            ),
      ])
